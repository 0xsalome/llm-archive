...
LLM書庫は、[experimental-commons](https://github.com/kotowari-modoki/experimental-commons) をフォークし、その設計思想、サイト構成、運用設計を参考にしながら、LLM書庫向けに改変して作成しています。

Original: experimental-commons
License: CC BY 4.0
